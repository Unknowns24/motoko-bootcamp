...
import { idlFactory } from './HWDiary.did.js';
export { idlFactory } from './HWDiary.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HWDIARY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./HWDiary.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the HWDiary canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./HWDiary.did.js")._SERVICE>}
 */
export const HWDiary = createActor(canisterId);
